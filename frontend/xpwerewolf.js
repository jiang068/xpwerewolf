                ...
                children: f.jsxs("div", {
                    ...
                    children: [f.jsxs("div", {
                        ...
                        children: f.jsx("button", {
                            ...
                            children: L ? "还没有账号？立即注册" : "已有账号？立即登录"
                        })
                    })]
                })
            })
                    ...
                    children: [f.jsx("div", {
                        ...
                        children: [f.jsx("h3", {
                            ...
                            children: [f.jsx("p", {
                                ...
                                children: "3. 所有人讨论并投票，猜测这个XP属于谁"
                            }), f.jsx("p", {
                                children: "4. 如果狼人没被投出，可以在夜晚击杀一名玩家"
                            }), f.jsx("p", {
        ...
        g = () => {
            ...
            const T = async () => {
                ...
                try {
                    ...
                    ce.message.includes("房间不存在") && (c("error", "错误", "房间已不存在"), s(null), o("lobby"))
                }
            }, I = async () => {
                Se(!0);
                try {
                    ...
                    children: [f.jsxs("div", {
                        ...
                        children: f.jsxs("div", {
                            ...
                            children: ["              ", !Q && f.jsx("button", {
                                ...
                                children: H.length < 4 ? `需要至少4名玩家 (当前${H.length}名)` : "等待所有玩家准备"
                            })]
                        })
                    })]
                })
            ...
            const St = async () => {
                ...
                if (a) try {
                    ...
                    if (q && q.xp_content && te(!0), ae.game.status === "finished" && (ae.game.winner ? w({
                            ...
                            isWolf: q ? Boolean(q.is_wolf) : false
                        }) : (c("info", "游戏已结束", "游戏因异常原因终止"), o("lobby"), u(null), s(null))), ae.votes && ae.votes.length > 0) {
                        const Ce = {};
                        ae.votes.forEach(Fe => {
                ...
                try {
                    (await N("/game/exit", "POST", {
                        game_id: a
                    })).game_terminated ? c("info", "游戏已终止", "") : c("success", "已退出", "你已退出游戏"), o("lobby"), u(null)
                } catch (A) {
                    c("error", "错误", A.message)
                } finally {
                    ce(!1)
                    ...
                    children: [f.jsx("div", {
                        ...
                        children: f.jsxs("div", {
                            ...
                            children: [f.jsxs("div", {
                                ...
                                onClick: () => {
                                    ...
                                    c("warning", "确认退出游戏", A >= 5 ? "确定要退出当前游戏吗？游戏将继续进行。" : "当前游戏人数较少，退出后游戏将自动终止本局，确定要退出吗？", Ll, "确认退出")
                                },
                        ...
                        children: [f.jsxs("div", {
                            ...
                            children: [f.jsx("h3", {
                                ...
                                children: Te && !Te.is_alive ? "观战模式 - 等待其他玩家投票" : T ? "等待其他玩家投票" : "讨论并投票"
                            }), Te && Te.is_alive && !T && f.jsx("p", {
                                className: "text-pink-200 text-sm",
                                children: "💭 先和大家讨论，分析谁是狼人，然后投出你的一票"
                            ...
                            children: f.jsxs("div", {
                                ...
                                children: [f.jsx(Qr, {
                                    ...
                                    children: Te.death_reason === "voted" ? "被投票出局" : Te.death_reason === "killed" ? "被狼人击杀" : Te.death_reason === "exited" ? "退出游戏" : ""
                                }), f.jsxs("div", {
                ...
                children: f.jsxs("div", {
                    ...
                    children: [f.jsx("div", {
                        ...
                        children: [f.jsxs("p", {
                            ...
                            children: [L === "wolves" ? "狼人阵营" : "村民阵营", " 获胜 "]
                        }), f.jsxs("p", {
                            className: "text-pink-200",
                            children: ["你的身份是", H ? "狼人" : "村民"]
                        }), f.jsx("p", {
                            className: "text-pink-200",
